...
print"If you want to calculate the tangent of an angle, press 1. "
print"If you want to calculate the thrid side of a right triangle, press 2"
...
if userchoice == 1:
        ...
        if float(side1 + side2) <= side3:
            ...
            x = "The tangent of the /_s1s2 is %20f." %(a)
            print x
